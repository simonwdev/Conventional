...
namespace Conventional
{
    public static class KnownPaths
    {
        ...
        private static readonly Func<string> DefaultSolutionRoot = () => Path.GetFullPath(Path.Combine(SolutionRootFinder(AppContext.BaseDirectory), $"..{Path.DirectorySeparatorChar}"));
